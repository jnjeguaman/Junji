...
define("EW_CONN_DB", "honorarios", TRUE);
...
define("EW_PROJECT_NAME", "project4", TRUE); // Project Name
define("EW_RANDOM_KEY", '9Sd51uRl#7%W3CX9', TRUE); // Random key for encryption
