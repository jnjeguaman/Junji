...
for($i=1;$i<$totalElementos;$i++)
{
	...
	$update1 = "UPDATE bode_detoc SET doc_recibidos = doc_recibidos + ".$unidad.", doc_final = doc_final + ".$unidad." WHERE doc_oc_id = ".$row["oc_id"]." AND doc_id_mercado_publico = '".$var2[$i]."' AND doc_region = '".$region."'";
	mysql_query($update1);
