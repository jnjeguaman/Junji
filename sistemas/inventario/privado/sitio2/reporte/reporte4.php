...
$guias = array_map("unserialize", array_unique(array_map("serialize", $guias)));
?>
<!DOCTYPE html>
<html>
<head>
	...
	<table id="tableDetalle">
		...
		//Obtenemos el detalle de la guia
			...
			while($row = mysql_fetch_array($res))
			{
				...
				<tr>
					<td id="espacio"><?php echo mb_convert_encoding($row["doc_especificacion"],"ISO-8859-1") ?></td>
					...
					<td id="espacio"><?php echo $value["FOLIO"] ?></td>
				</tr>
