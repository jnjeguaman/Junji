		...
		<form action="bode_desp_gr.php" method="POST" onSubmit="return valida()">
			<table border="1" width="100%">
				...
				<tr>
					...
					<tr>
						<td class="Estilo1">NOMBRE CHOFER</td>
						<td class="Estilo1"><input type="text" name="chofer_nombre" id="chofer_nombre" required class="Estilo1"></td>
					</tr>
				...
				<input type="hidden" name="cmd" value="AgregarChofer">
			</form>
			...
			<?php else: ?>
				<p class="Estilo1mc" style="color:red;">Ha ocurrido un error al agregar el transportista.<i class="fa fa-warning fa-lg"></i></p>
			<?php endif ?>
		<?php endif ?>
		</div>
