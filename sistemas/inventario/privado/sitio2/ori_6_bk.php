	...
	<form name="form1" action="inv_actualiza_orden.php" method="post" onSubmit="return validar3()">
		...
		<table border="0" width="100%">
			...
			<tr>
				...
				<?php else: ?>
					<td class="Estilo1c">N° O/C</td>
					<td class="Estilo1c"><input type="text" name="oc_numero" id="oc_numero" value="<?php echo $row["oc_numero"] ?>" class="Estilo2" readonly style="background-color: rgb(235, 235, 228)"/></td>
				<?php endif ?>
			</tr>
