...
if ($regionsession==16){
?>
                               <select name="numerooc1">
                                 <option value="">Seleccione...</option>
                                 <option value="599" <? if ($numerooc1==599) { echo "selected=selected"; } ?> >599</option>
                                 <option value="856" <? if ($numerooc1==856) { echo "selected=selected"; } ?> >856</option>
                               </select>
<?
} else {
?>
