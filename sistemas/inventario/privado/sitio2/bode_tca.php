	...
	<tr>
		...
		<td align="center" width="80%">
			<table border="0" width="100%" cellpadding="3">
				...
				<tr>
					<td>COMPROBANTE DE RECEPCION TÉCNICA</td>
				</tr>
...
<table border="1" width="100%" cellpadding="2">
	...
	<tr>
		...
		<td style="font-size:10px;">'.mb_convert_encoding($row5["oc_proveenomb"],"ISO-8859-1").'</td>
	</tr>
	...
	<tr>
		...
		<td style="font-size:10px;">'.$row5["ing_guiaemisortc"].'</td>
	</tr>
...
<table border="0" width="100%" align="center">
	...
	<tr>
		<td style="font-size:10px;text-align:center;">'.$row5["ing_guiaemisortc"].'</td>
