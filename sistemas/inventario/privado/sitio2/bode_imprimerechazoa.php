...
//$fechaguia=substr($row5["ing_guiafechatc"],8,2)."-".substr($row5["ing_guiafechatc"],5,2)."-".substr($row5["ing_guiafechatc"],0,4);
	...
	<table width="500" border="1">
		<tr>
			<td class="Estilo1b3" width="150">Fecha Recepción</td>
			<td class="Estilo1b3"><? echo $fechaguia ?></td>
		</tr>
		<tr>
			<td class="Estilo1b3" >Estado</td>
			<td class="Estilo1b3">RECHAZADA</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="Estilo1b3"><? echo utf8_decode($row5["ing_guiaemisorrrchzo"]); ?> </td>
		</tr>
	...
	<table width="500" border="1" height="500">
		...
		while ($row4 = mysql_fetch_array($res4)) {
			...
			<tr>
				...
				<td class="Estilo1c3"> <? echo utf8_decode($row4["ding_glosa_rechazo"]); ?></td>
			</tr>
  ...
  // $resultado=convertir($bruto);
	...
	<table width="500" border="0">
		...
		<tr>
			<th class="Estilo1b"><? echo utf8_decode($row5["ing_guiaemisorrrchzo"]) ?></th>
			<th class="Estilo1b">
				<?php if ($row5["ing_rechazado"] <> ''): ?>
					<?php echo utf8_decode($row5["ing_rechazado"]) ?>
				<?php endif ?>
			</th>
			<th class="Estilo1b"><br></th>
		</tr>
