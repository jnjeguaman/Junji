...
?>
                           <tr>
                             ...
                             <td class="Estilo1c3"> <? echo number_format($row4["ding_cantidad"],0,',','.'); ?></td>
...
?>
					...
					<table width="500" border="0">
                             ...
                             <tr>
                               <th class="Estilo1b">VºBº <BR> ENCARGADO ABASTECIMIENTO</th>
                               <th class="Estilo1b">VºBº <BR> RESPONSABLE RECEPCION <BR><? echo $row5["ing_guiaemisortc"] ?></th>
