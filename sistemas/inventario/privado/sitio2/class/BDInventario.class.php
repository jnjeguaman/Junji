...
class BDInventario {
	...
	public function conectaMaster(){
		$this->_db_insert=new PDO('mysql:host='.Configuracion::$host_bd_inventario.';port='.Configuracion::$port_bd_maestro_inventario.';dbname='.Configuracion::$name_bd_inventario, Configuracion::$user_bd_inventario, Configuracion::$pass_bd_inventario,array(PDO::ATTR_PERSISTENT=>true));
	...
	public function conectaSlave(){
		$this->_db_select=new PDO('mysql:host='.Configuracion::$host_bd_inventario.';port='.Configuracion::$port_bd_replica_inventario.';dbname='.Configuracion::$name_bd_inventario, Configuracion::$user_bd_inventario, Configuracion::$pass_bd_inventario,array(PDO::ATTR_PERSISTENT=>true));						
	...
	public function conectaSlavecomoMaster(){
		$this->_db_select=new PDO('mysql:host='.Configuracion::$host_bd_inventario.';port='.Configuracion::$port_bd_maestro_inventario.';dbname='.Configuracion::$name_bd_inventario, Configuracion::$user_bd_inventario, Configuracion::$pass_bd_inventario,array(PDO::ATTR_PERSISTENT=>true));
		$this->_db_select->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
		$this->_db_select->setAttribute(PDO::MYSQL_ATTR_USE_BUFFERED_QUERY,true);
	}
