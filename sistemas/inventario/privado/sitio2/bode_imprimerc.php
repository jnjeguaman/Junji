...
<body>
 ...
 //$sql5="SELECT * FROM bode_detingreso x, bode_ingreso y, bode_orcom z where x.ding_prod_id = $doc_id and x.ding_ing_id=y.ing_id and x.ding_recep_tecnica = 'A' and y.ing_oc_id=z.oc_id and y.ing_guianumerotc='$numguia' group by y.ing_guianumerotc ";
	//$sql5="SELECT * FROM bode_detingreso x, bode_ingreso y, bode_orcom z where x.ding_ing_id=y.ing_id and x.ding_recep_tecnica = 'A' AND x.ding_recep_conforme = 'C' and y.ing_oc_id=z.oc_id and y.ing_guianumerorc='$numguia'";
       // OK $sql5="SELECT * FROM bode_detingreso x, bode_ingreso y, bode_orcom z, bode_detoc a where /*x.ding_prod_id = $doc_id and*/ x.ding_ing_id=y.ing_id and x.ding_recep_tecnica = 'A' and y.ing_oc_id=z.oc_id and y.ing_guianumerorc='$numguia' AND a.doc_id = x.ding_prod_id";
       $sql5="SELECT SUM(ding_cantidad) as ding_cantidad, ding_cant_rechazo, doc_especificacion, doc_region, ding_fentrega,oc_proveenomb, oc_id2, oc_prog, ing_guiaemisorrc,ing_guia,oc_monto,doc_unit,doc_umedida, ing_aprobado,ing_region FROM bode_detingreso x, bode_ingreso y, bode_orcom z, bode_detoc a where /*x.ding_prod_id = $doc_id and*/ x.ding_ing_id=y.ing_id and x.ding_recep_tecnica = 'A' and y.ing_oc_id=z.oc_id and y.ing_guianumerorc='$numguia' AND a.doc_id = x.ding_prod_id AND x.ding_estado = 1 GROUP BY a.doc_especificacion";
// echo $sql5;
	$res5 = mysql_query($sql5);
	$row5 = mysql_fetch_array($res5);

//$sql6 = "SELECT * FROM bode_ingreso a INNER JOIN bode_detoc b on b.doc_oc_id = a.ing_oc_id WHERE ing_oc_id = ".$row5["oc_id"];
	$sql6 = "SELECT * FROM bode_detingreso x, bode_ingreso y, bode_orcom z, bode_detoc w where x.ding_prod_id = $doc_id and x.ding_ing_id=y.ing_id and x.ding_recep_tecnica = 'A' AND x.ding_recep_conforme = 'C' and y.ing_oc_id=z.oc_id and y.ing_guianumerorc = '$numguia' and x.ding_prod_id = w.doc_id";
//echo "<br>".$sql6;
		...
		<tr>
			...
			<td class="Estilo1b3"><? echo $fechaguia ?></td>
                     	...
                     	<tr>
                     		...
                     		<td class="Estilo1b3"><? echo utf8_decode($row5["ing_guiaemisorrc"]); ?> </td>
                     	</tr>
                     	...
                     	<tr>
                            ...
                            <tr>
                                   <td class="Estilo1b3">Valor lote O/C</td>
                                   <td class="Estilo1b3">$<? echo number_format($row5["oc_monto"],0,".","."); ?> </td>
                            </tr>
                     </table>
                     <br>
                     <br>
                     <table width="500" border="1" height="300">
                     	<tr height="20">
                     		...
                     		<th class="Estilo1b3" width="50">VALOR UNT.</th>
                     	</tr>
                     	...
                     	$sql4 = "SELECT * FROM bode_detingreso x, bode_ingreso y, bode_orcom z, bode_detoc w where x.ding_prod_id = $doc_id and x.ding_ing_id=y.ing_id and x.ding_recep_tecnica = 'A' and y.ing_oc_id=z.oc_id and y.ing_guianumerotc<>0 and x.ding_prod_id = w.doc_id AND y.ing_guianumerotc = '$numguia'";
...
//   echo $sql4;
                     	...
                     	while ($row4 = mysql_fetch_array($res4)) {
                     		...
                     		?>
                     		<tr>
                     			<td class="Estilo1b3"> <? echo $row4["doc_region"]; ?></td>
                     			<td class="Estilo1b3"> <? echo utf8_decode($row4["doc_especificacion"]); ?></td>
                     			<td class="Estilo1b3"> <? echo $row4["doc_umedida"]; ?></td>
                     			<td class="Estilo1c3"> <? echo number_format($totallinea,0,',','.'); ?></td>
                     			<td class="Estilo1c3">$<? echo number_format($row4["doc_unit"],0,".","."); ?></td>
                     		</tr>
  ...
  // $resultado=convertir($bruto);
                     ...
                     <table width="500" border="0">
                     	...
                     	<tr>
                     		<th class="Estilo1b"><? echo utf8_decode($row5["ing_guiaemisorrc"]) ?></th>
                     		<th class="Estilo1b">
                     			<?php if ($row5["ing_aprobado"] <> ''): ?>
