					...
					<tbody>
						<?php while($row=mysql_fetch_array($res)) { ?>
							<tr>
								...
								<td><?php echo $row["region_encargado"] ?></td>
								<td><?php echo $row["region_dir_bodega"] ?></td>
								<td><a href="?page=encargados2&action=edit&id=<?php echo $row["region_id"] ?>" class="btn btn-warning"><i class="fa fa-pencil"></i></a></td>
							</tr>
							<?php } ?>
						</tbody>
