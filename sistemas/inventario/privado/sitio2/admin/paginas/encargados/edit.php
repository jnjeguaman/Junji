...
{
	$update = "UPDATE acti_region SET region_envinv = '".$_POST["region_envinv"]."' WHERE region_id = ".$_POST["region_id"];
	mysql_query($update,$dbh);
	echo "<script>window.location.href='?page=encargados';</script>";
}
?>
<div class="">
				...
				<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="<?php echo $_SERVER["REQUEST_URI"] ?>">
					...
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="text" disabled class="form-control col-md-7 col-xs-12" value="<?php echo $row["region_envinv"] ?>">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="text" id="region_envinv" name="region_envinv" required="required" class="form-control col-md-7 col-xs-12">
						</div>
					</div>
