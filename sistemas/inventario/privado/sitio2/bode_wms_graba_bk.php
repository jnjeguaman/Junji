...
$sql = "INSERT INTO bode_orcom (oc_region,oc_region2,oc_fecha,oc_fecha_recep,oc_usu,oc_proveenomb,oc_swdespacho,oc_tipo_guia,oc_tipo,oc_region_destino,oc_wms) VALUES ('".$var[1][2]."','".$regionSession."','".date("Y-m-d",strtotime($var[1][3]))."','".$fechamia."','".$nombrecom."','CENTRAL DE ABASTECIMIENTO','1','".$var[1][1]."','1','".$var[1][4]."','".$var[1][5]."')";
// echo $sql;
mysql_query($sql);
...
?>
	<script type="text/javascript">
    	window.location.href="bode_inv_indexoc4.php?cmd=WMS&ori=2";
    </script>
