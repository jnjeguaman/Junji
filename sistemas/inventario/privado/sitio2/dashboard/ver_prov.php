		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
			    <div class="box span12">
				    <?
					 // $consulta="select * from acti_proveedor where pro_
					?>
					Proveedor<br>
					RUT : <strong><? echo $v_proveedor_rut,"-",$v_proveedor_dv ?></strong><br>
					Razón Social : <strong><? echo $v_proveedor_glosa ?></strong>
				</div>
			</div>
			<div class="row-fluid">
			    <div class="box span12">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
						    <?
							    $consulta="select * from bode_orcom where oc_proveerut = '$f_prov'";
