		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
			   ...
			   <div class="box span12">
				  ...
				  ?>
			      <a href="ver_oc.php" class="label <? echo $cod_color ?>">Todas</a>&nbsp;&nbsp;
			      <?
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
						    <?
							    if ($id_region==""){
							          $consulta="select * from bode_orcom where oc_tipo = 0";
							    } else {
								      $consulta="select * from bode_orcom where oc_tipo = 0 and oc_region='$id_region'";
                                }								
								$res = mysql_query($consulta);
								while ($arr=mysql_fetch_array($res)){
								    $v_oc_id	        = $arr['oc_id'];
