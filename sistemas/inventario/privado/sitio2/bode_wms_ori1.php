...
// LEEMOS EL ARCHIVO
						...
						<table border="1" width="100%">
							...
							<tr>
								...
								// $sql_oc = "SELECT * FROM bode_orcom a INNER JOIN bode_detoc b on b.doc_oc_id = a.oc_id WHERE a.oc_id2 = '".$csv[$i][4]."' AND a.oc_estado = 1 AND a.oc_tipo = 0 AND b.doc_id_mercado_publico = '".$csv[$i][0]."'";
								...
								<td class="Estilo1mc"><?php echo ($row_oc["doc_id_mercado_publico"] <> $csv[$i][0]) ? "<font color='#EA2525'><i class='fa fa-ban fa-lg'></i></font>" : "<font color='#23C213'><i class='fa fa-check'></i></font>" ?></td>
