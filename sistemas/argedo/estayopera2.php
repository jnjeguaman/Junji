                          ...
                          <TR>
                            <TD vAlign=top width="70%">
                              ...
                              border=0>
                                ...
                                <TR>
<form method="get" action="estayopera2.php">
...
?>
                                ...
                                <TR>
                                  ...
                                  <TD class=ms-vb style="PADDING-LEFT: 5px; PADDING-BOTTOM: 5px" bgcolor="#81DAF5">Tiempo Promedio <br> Ingreso (días) </TD>
                                  <TD class=ms-vb style="PADDING-LEFT: 5px; PADDING-BOTTOM: 5px" bgcolor="#81DAF5">Resolución <br> Exenta</TD>
                                  <TD class=ms-vb style="PADDING-LEFT: 5px; PADDING-BOTTOM: 5px" bgcolor="#81DAF5">Resolución <br> Afecta</TD>
                                  <TD class=ms-vb style="PADDING-LEFT: 5px; PADDING-BOTTOM: 5px" bgcolor="#81DAF5">Oficio</TD>
                                  <TD class=ms-vb style="PADDING-LEFT: 5px; PADDING-BOTTOM: 5px" bgcolor="#81DAF5">TOTAL Documentos <br> Oficiales</TD>
                                  <TD class=ms-vb style="PADDING-LEFT: 5px; PADDING-BOTTOM: 5px" bgcolor="#81DAF5">Correspondencia <br> Recibida</TD>
                                  <TD class=ms-vb style="PADDING-LEFT: 5px; PADDING-BOTTOM: 5px" bgcolor="#81DAF5">Correspondencia <br> Despachada</TD>
...
//    $sql3="SELECT avg(docs_diferencia) as diferencia FROM argedo_documentos WHERE docs_defensoria = '$codigo' AND docs_documento <> '' and  (docs_fechaparte>=$fechaini and docs_fechaparte<=$fechater) ";
    $sql3="SELECT avg(docs_diferencia) as diferencia FROM argedo_documentos WHERE docs_defensoria = '$codigo' AND docs_documento <> '' and  (docs_fechasis>='$fechaini' and docs_fechasis<='$fechater')";
//     echo $sql3;
    $result3=mysql_query($sql3,$link);
    $row3=mysql_fetch_array($result3);
    $diferencia=$row3["diferencia"];

    $sql3="SELECT count(reci_defensoria) as totalreci FROM argedo_recibida WHERE reci_defensoria = '$codigo'  and  ( reci_fechasys >='$fechaini' and  reci_fechasys <='$fechater')  ";
//    echo $sql3."<br>";
    $result3=mysql_query($sql3,$link);
    $row3=mysql_fetch_array($result3);
    $totalreci=$row3["totalreci"];

    $sql3="SELECT count(despa_documento) as totaldespa FROM argedo_despachada WHERE despa_defensoria = '$codigo'  and (despa_fechasys >='$fechaini' and  despa_fechasys<='$fechater')  ";
    // echo $sql3;
    $result3=mysql_query($sql3,$link);
    $row3=mysql_fetch_array($result3);
    $totaldespa=$row3["totaldespa"];
    
    $sql3="SELECT count(eta_tipo_doc) as totalfactura FROM dpp_etapas WHERE eta_region = '$codigo' and (eta_fecha_ing>='$fechaini' and  eta_fecha_ing<='$fechater')  ";
    // echo $sql3;
    $result3=mysql_query($sql3,$link);
    $row3=mysql_fetch_array($result3);
    $totalfactura=$row3["totalfactura"];
     ...
     ?>
                                ...
                                <TR>
                                  ...
                                  <TD class=ms-vb style="PADDING-CENTER: 5px; PADDING-BOTTOM: 5px"><? echo number_format($diferencia,2,',','.') ?> </TD>


     <?

    $sql2="SELECT docs_documento, count( docs_documento ) AS total FROM argedo_documentos WHERE docs_defensoria = '$codigo' AND docs_documento = 'RESOLUCION EXENTA' and  (docs_fechasis>='$fechaini' and docs_fechasis<='$fechater') GROUP BY docs_documento ORDER BY docs_documento ";
//    echo $sql2;
    $result2=mysql_query($sql2,$link);
    $row2=mysql_fetch_array($result2);
    $totalexe=$row2[1];

    $sql2="SELECT docs_documento, count( docs_documento ) AS total FROM argedo_documentos WHERE docs_defensoria = '$codigo' AND docs_documento = 'RESOLUCION AFECTA' and  (docs_fechasis>='$fechaini' and docs_fechasis<='$fechater') GROUP BY docs_documento ORDER BY docs_documento ";
//    echo $sql2;
    $result2=mysql_query($sql2,$link);
    $row2=mysql_fetch_array($result2);
    $totalafec=$row2[1];
    ...
    $sql2="SELECT docs_documento, count( docs_documento ) AS total FROM argedo_documentos WHERE docs_defensoria = '$codigo' AND docs_documento = 'OFICIO' and  (docs_fechasis>='$fechaini' and docs_fechasis<='$fechater') GROUP BY docs_documento ORDER BY docs_documento ";
//    echo $sql2;
    $result2=mysql_query($sql2,$link);
    $row2=mysql_fetch_array($result2);
    $totaloficio=$row2[1];
...
?>
       ...
       <TD class=ms-vb style="PADDING-LEFT: 5px; PADDING-BOTTOM: 5px"><? echo $totalexe; ?> </TD>
       <TD class=ms-vb style="PADDING-LEFT: 5px; PADDING-BOTTOM: 5px"><? echo $totalafec; ?> </TD>
       <TD class=ms-vb style="PADDING-LEFT: 5px; PADDING-BOTTOM: 5px"><? echo $totaloficio; ?> </TD>
<?
        $suma1=$totalexe+$totalafec+$totaloficio;
