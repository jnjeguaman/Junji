...
//------------- Comineza el mail  ----------------------
  ...
  $msg.="<tr><td><p style='font-style:italic;color:#EC0303'>�Debe considerar que en virtud de la Ley N� 19.628 Sobre Protecci�n a la Vida Privada Usted est� en la obligaci�n de guardar secreto sobre los datos de car�cter personal y/o sensible contenidos en los documentos que se adjuntan para su conocimiento y exclusiva tramitaci�n de acuerdo a las competencias de este Servicio, toda vez que dichos datos provienen y/o han sido recolectados de fuentes no accesibles al p�blico y se requiere del consentimiento del titular del dato para su tratamiento y/o divulgaci�n. Para lo anterior, debe considerar que el tratamiento de datos personales por parte de un organismo p�blico s�lo podr� efectuarse respecto de las materias de su competencia y con sujeci�n a la norma mencionada. En esas condiciones, no necesitar� el consentimiento del titular.�</p></td></tr>";
...
//             $linkarchivo1="../../archivos/docargedo/".$archivo1;
             $msg.="Ver archivo1 (pinche aqu�): <a href='http://10.16.25.63/sistemas/archivos/docargedo/".$archivo1."'>Ver Archivo 1</a><br><br>";
        }
        if ($archivo2<>'') {
//             $linkarchivo2="../../archivos/docargedo/".$archivo2;
             $msg.="Ver archivo2 (pinche aqu�): <a href='http://10.16.25.63/sistemas/archivos/docargedo/".$archivo2."'>Ver Archivo 1</a><br><br>";
        }
        if ($archivo3<>'') {
//             $linkarchivo3="../../archivos/docargedo/".$archivo3;
             $msg.="Ver archivo3 (pinche aqu�): <a href='http://10.16.25.63/sistemas/archivos/docargedo/".$archivo3."'>Ver Archivo 1</a><br><br>";
        }

        if ($archivo4<>'') {
//             $linkarchivo4="../../archivos/docargedo/".$archivo4;
             $msg.="Ver archivo4 (pinche aqu�): <a href='http://10.16.25.63/sistemas/archivos/docargedo/".$archivo4."'>Ver Archivo 1</a><br><br>";
        }
...
*/
        ...
        // $msg.="<br><br>";
        // $msg.="<p style='font-size:1.2em;font-style:italic;color:#EC0303'>Debe considerar que en virtud de la Ley N� 19.628 Sobre Protecci�n a la Vida Privada Usted est� en la obligaci�n de guardar secreto sobre los datos de car�cter personal y/o sensible contenidos en los documentos que se adjuntan para su conocimiento y exclusiva tramitaci�n de acuerdo a las competencias de este Servicio, toda vez que dichos datos provienen y/o han sido recolectados de fuentes no accesibles al p�blico y se requiere del consentimiento del titular del dato para su tratamiento y/o divulgaci�n. Para lo anterior, debe considerar que el tratamiento de datos personales por parte de un organismo p�blico s�lo podr� efectuarse respecto de las materias de su competencia y con sujeci�n a la norma mencionada. En esas condiciones, no necesitar� el consentimiento del titular.�</p>";
  //     echo $msg;
        $msg.='</table>';
