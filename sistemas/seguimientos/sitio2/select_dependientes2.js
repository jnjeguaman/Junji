...
//            alert(" numero de palabras "+ array_palabras);
       document.form1.documento.value=array_palabras[0];
//       document.form1.dias.value=array_palabras[1];
	...
	if(opcionSeleccionada==0)
	{
		...
		while(listadoSelects[x])
		{
            ...
            document.form1.documento.value="xx";
	...
	else if(idSelectOrigen!=listadoSelects[listadoSelects.length-1])
	{
		...
		var ajax=nuevoAjax();
                idSelectDestino="estados";
		ajax.open("GET", "select_dependientes_proceso2.php?select="+idSelectDestino+"&opcion="+opcionSeleccionada+"&ocid="+ocid, true);
//            alert(" numero de palabras 2 ->"+ idSelectDestino +" --> "+opcionSeleccionada);

            document.form1.tipo2.value=opcionSeleccionada;
