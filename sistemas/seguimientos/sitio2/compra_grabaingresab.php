...
$sql="select max(compra_folio) as folio from compra_compra where compra_region='$regionsession' and compra_origen=1 and compra_anno=2014 order by compra_id desc ";
//echo $sql;
...
//exit();
echo "<script>location.href='compra_ingresab.php?llave=1';</script>";
