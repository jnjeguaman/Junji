...
//--- Regla 10 mismo monto en positivo y en negactivo  en cargo o mismo monto en abono y numero de documento igual a cero

     $sql2="select *  from  concilia_sigfe where sigfe_numdoc=0 and sigfe_region='$regionsession' and sigfe_estado=1 and (sigfe_cargo<0 or sigfe_abono<0) and sigfe_numero='$numero'";
//     echo $sql2.">>1<br><br>";
//     exit();
     ...
     while ($row2 = mysql_fetch_array($res2)) {
       ...
       $sigfecargo2=$row2["sigfe_cargo"]*-1;
        $sql3="select *  from  concilia_sigfe where sigfe_cargo=$sigfecargo2 and sigfe_cargo<>0 and sigfe_numdoc=0 and sigfe_region='$regionsession' and sigfe_estado=1 and sigfe_numero='$numero' ";
//       echo $sql3.">>2<br><br>";
       $sigfeid2="";
       $res3 = mysql_query($sql3);
       $row3 = mysql_fetch_array($res3);
       $sigfecargo3=$row3["sigfe_cargo"];
       $sigfeid2=$row3["sigfe_id"];

       if ($sigfecargo2==$sigfecargo3 and $sigfeid2<>'') {
          $sql="insert into concilia_indice (indi_carto_id,indi_sigfe_id,indi_fechasys,indi_user,indi_tipo)
                                     values ('$sigfeid1', '$sigfeid2', '$fechamia','$usuario' , '10')";
//          echo $sql.">>3<br>";
          mysql_query($sql);
...
//          echo $sql.">>4<br>";
       ...
       $sigfeid2="";
       $sigfeabono2=$row2["sigfe_abono"]*-1;
       $sql3="select *  from  concilia_sigfe where sigfe_abono=$sigfeabono2 and sigfe_abono<>0 and sigfe_numdoc=0 and sigfe_region='$regionsession' and sigfe_estado=1 and sigfe_numero='$numero' ";
//       echo $sql3.">>22<br><br>";
       $res3 = mysql_query($sql3);
       $row3 = mysql_fetch_array($res3);
       $sigfeabono3=$row3["sigfe_abono"];
       $sigfeid2=$row3["sigfe_id"];

       if ($sigfeabono2==$sigfeabono3 and $sigfeid2<>'') {
          $sql="insert into concilia_indice (indi_carto_id,indi_sigfe_id,indi_fechasys,indi_user,indi_tipo)
                                     values ('$sigfeid1', '$sigfeid2', '$fechamia','$usuario' , '10')";
//          echo $sql.">>33<br>";
          mysql_query($sql);
...
// --- Regla 2 los directo numero de documento y numero de sigfe ademas el monto es todo lo mismo.
     $sql2="select *
     from concilia_cartola x, concilia_sigfe y
     where x.carto_operacion=y.sigfe_numdoc and x.carto_cargo=y.sigfe_abono and x.carto_cargo<>0 and y.sigfe_abono<>0  and  (y.sigfe_estado2 <>'AJUSTADO' and y.sigfe_estado2 <>'AJUSTE') and (x.carto_estado=1 and y.sigfe_estado=1) and (x.carto_region='$regionsession' and y.sigfe_region='$regionsession') and (x.carto_numero='$numero' and y.sigfe_numero='$numero') ";
//     echo $sql2.">>1<br><br>";
//     exit();
     $res2 = mysql_query($sql2);
     $cont=1;
...
//--- Regla 3 ajuste con ajustados sumatoria si cuadra todo se hace el updates de los ajustados con los ajustes
     $sql=" select sum(sigfe_abono) as m11 from concilia_sigfe where sigfe_estado2='AJUSTADO' and sigfe_estado=1 and sigfe_region='$regionsession' and sigfe_numero='$numero'";
...
//     echo $sql."<br>";
     ...
     $sql=" select sum(sigfe_abono) as m22 from concilia_sigfe where sigfe_estado2='AJUSTE' and sigfe_estado=1 and sigfe_region='$regionsession' and sigfe_numero='$numero'";
...
//         echo "entra";
        ...
        from concilia_sigfe where (sigfe_estado2='AJUSTADO' or sigfe_estado2 ='AJUSTE') and sigfe_estado=1 and sigfe_region='$regionsession' and sigfe_numero='$numero' ";
//        echo $sql."<br>";
        mysql_query($sql);


        $sql="update concilia_sigfe set sigfe_estado=2 where (sigfe_estado2='AJUSTADO' or sigfe_estado2 ='AJUSTE') and sigfe_estado=1 and sigfe_region='$regionsession' and sigfe_numero='$numero' ";
        mysql_query($sql);
//        echo $sql."<br>";
...
//****--- Regla 1 1720 son tranferencias los agrupados en la subida del sigfe por los numero correlativos de la cartola tranferencia
      ...
      $sql="select sum(sigfe_abono) as total, sigfe_numdoc from concilia_sigfe
                       where sigfe_user='$usuario' and sigfe_numero='$numero'
...
//       echo $sql;
       ...
       while ($row = mysql_fetch_array($res)) {
          ...
          $total2='';
          $sql2="select * from concilia_cartola where carto_operacion='1720'  and carto_user='$usuario' and carto_estado=1 and carto_cargo='$total' and carto_region='$regionsession' and carto_numero='$numero' ";
//          echo $sql2."<br>";
          $res2=mysql_query($sql2);
          $row2 = mysql_fetch_array($res2);
...
//          echo $total2."<--<br>";
          if ($total2<>'') {
              $sql3="insert into concilia_indice (indi_carto_id,indi_sigfe_id,indi_fechasys,indi_user,indi_tipo)
                       ...
                       where y.sigfe_numdoc='$numdoc' and sigfe_user='$usuario' and sigfe_numero='$numero'
                        and (sigfe_bene <>'BANCO DEL ESTADO DE CHILE'  AND sigfe_bene <>'DEFENSORIA PENAL PUBLICA'
                        AND sigfe_bene <>'MSLI LATAM INC.'
                        AND sigfe_bene <>'TESORERIA GENERAL DE LA REPUBLICA'
...
//              echo $sql4."<br><br>";
              ...
              $sql4="update concilia_sigfe set sigfe_estado=2 where sigfe_numdoc='$numdoc' and sigfe_user='$usuario'  and sigfe_numero='$numero'
                        and (sigfe_bene <>'BANCO DEL ESTADO DE CHILE'  AND sigfe_bene <>'DEFENSORIA PENAL PUBLICA'
                        AND sigfe_bene <>'MSLI LATAM INC.'
                        AND sigfe_bene <>'TESORERIA GENERAL DE LA REPUBLICA'
...
//     echo $sql2.">1<br><br>";
     ...
     while ($row2 = mysql_fetch_array($res2)) {
       ...
       $sql3=" select * from concilia_cartola where carto_estado='1' and carto_operacion='$sigfenumdoc' and carto_cargo='$sigfeabono' and carto_region='$regionsession' and carto_numero='$numero' order by carto_fecha  ";
//       echo $sql3.">2<br><br>";
       $res3 = mysql_query($sql3);
       $row3 = mysql_fetch_array($res3);
...
// buscar por cartola abono y sigfe cargo
     ...
     from concilia_cartola x, concilia_sigfe y where x.carto_abono=y.sigfe_cargo and x.carto_estado=1 and y.sigfe_estado=1 and (x.carto_abono<>0 and y.sigfe_cargo<>0) and (x.carto_region='$regionsession' and y.sigfe_region='$regionsession') and (x.carto_numero='$numero' and y.sigfe_numero='$numero') group by x.carto_abono order by sigfe_id ";
//     echo $sql."<br>";
//     exit();
     mysql_query($sql);
      ...
      $sql=" select (x.carto_id) as carto,  (y.sigfe_id) as sigfe,'$fechamia','$usuario' , '4'
             from concilia_cartola x, concilia_sigfe y
             where x.carto_abono=y.sigfe_cargo and x.carto_estado=1 and y.sigfe_estado=1 and (x.carto_abono<>0 and y.sigfe_cargo<>0) and (x.carto_region='$regionsession' and y.sigfe_region='$regionsession') and (x.carto_numero='$numero' and y.sigfe_numero='$numero') group by x.carto_abono order by sigfe_id ";
//     echo $sql."<br>";
       $res=mysql_query($sql);
       while ($row = mysql_fetch_array($res)) {
          $carto=$row["carto"];
...
//--------------------- 4  Buscar por cartola cargo y sigfe abono
     $sql="insert into concilia_indice (indi_carto_id,indi_sigfe_id,indi_fechasys,indi_user,indi_tipo) select (x.carto_id) as carto,  (y.sigfe_id) as sigfe,'$fechamia','$usuario' , '4'
     from concilia_cartola x, concilia_sigfe y where x.carto_cargo=y.sigfe_abono and x.carto_estado=1 and y.sigfe_estado=1 and (x.carto_cargo<>0 and y.sigfe_abono<>0) and (x.carto_region='$regionsession' and y.sigfe_region='$regionsession') and (x.carto_numero='$numero' and y.sigfe_numero='$numero') group by x.carto_cargo order by sigfe_id";
//     echo $sql."<br>";
//exit();
     mysql_query($sql);
