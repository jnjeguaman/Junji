...
//echo $archivo1."-----".$extension."<br>";
    ...
    if ($archivo1 != "" or 1==1) {
        $archivo1="sigfe_".$regionsession."_".date("YmdHis").".".$extension;

        // guardamos el archivo a la carpeta files
        $destino =  "../../archivos/docconciliacion/subidos/".$archivo1;
//        echo $destino;
 //       echo $destino;
...
//        echo "entra 2 ===".$_DATOS_EXCEL[$i]['a12']." <br>";
    ...
    $rut=$b1;
                ...
                $sql="insert into concilia_sigfetmp (blanco1,blanco2,blanco6,blanco9,blanco10,blanco11, blanco12, user, blanco5 )
                                              values ('".$a63."','0','".$a6."','".$_DATOS_EXCEL[$i]['a9']."','".$_DATOS_EXCEL[$i]['a13']."','".$_DATOS_EXCEL[$i]['a11']."','".$_DATOS_EXCEL[$i]['a12']."','$user', '$rut') ";
          //      echo $sql."<br>";
               mysql_query($sql);
      }
//exit();
