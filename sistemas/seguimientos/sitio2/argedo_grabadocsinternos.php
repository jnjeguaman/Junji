...
$tipoDOC = ($tipodoc == "Otro") ? $tipodoc2 : $tipodoc;

$sql1=" INSERT INTO argedo_doc_internos (inte_region, inte_fecha_recepcion, inte_tipo_doc, inte_num_doc, inte_remitente, inte_destinatario, inte_materia, inte_usu_ing, inte_fecha_ing, inte_observacion, inte_estado) 

        VALUES ('$regionsession', '$fecha_recepcion', '$tipoDOC', '$num_doc', '$remitente','$destinatario', '$materia', '$usuario', '$fechamia', '$observacion', '1')";
...
echo "<script>location.href='argedo_docsinternos.php?sw=1';</script>";
