...
$mail->Host       = "DPP-EXMBSRV01.defensoria.local"; // SMTP server
$mail->SMTPDebug  = 2;                     // enables SMTP debug information (for testing)
                                           // 1 = errors and messages
                                           // 2 = messages only

$mail->SetFrom('admin@aestudiar.cl', 'First Last');

$mail->AddReplyTo("c_herrera_m@hotmail.com","First Last");
