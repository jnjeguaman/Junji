...
if (isset($_GET['fecha1']) && isset($_GET['fecha2'])) {
	$fecha1=$_GET['fecha1'];
	$fecha2=$_GET['fecha2'];
	$where=" eta_fechaguia2 >= '$fecha1' AND eta_fechaguia2 <= '$fecha2' AND ";
}
require_once("inc/config.php");
$sql = "SELECT * FROM dpp_etapas WHERE $where eta_region = ".$regionSession." AND eta_fechaguia2 >= '2017-02-01 00:00:00' AND eta_destinatario2 <> '' ORDER BY eta_fecha_ing DESC";
$res = mysql_query($sql);
$hoy = date("Y-m-d");
//echo $sql;
?>
...
<table border="1" width="100%">
	...
	<tr>
		...
		<td style="text-transform: uppercase;"><?php echo ($row["eta_fechaguia2"] <> '' || $row["eta_fechaguia2"] <> '0000-00-00') ? "ENVIADO" : "SIN ENVIAR" ?></td>
