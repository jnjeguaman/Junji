...
<table width=100%>
 <tr>
  ...
  <td width=50%>
   <form method="get" action="compra_grafico.php"  name="form2" >
...
//                        $strXML .= "<set label='" . $ors['uno'] . "' value='" . $ors['total'] . "' link='" . urlencode("Detailed.php?FactoryId=" . $ors['FactoryId']) . "'/>";
                        ...
                        foreach ($arrData as $arSubData) {
                            ...
                            $strDataCurr .= "<set value='" . $arSubData[2] . "' link='" . urlencode("compra_grafico.php?unidad=" . $arrData2[$j][1]) . "&anno=".$anno."'/>";
                            $strDataPrev .= "<set value='" . $arSubData[3] . "' link='" . urlencode("compra_grafico.php?unidad=" . $arrData2[$j][1]) . "&anno=".$anno."'/>";
                            $j++;
                        }
...
?>
 <tr>
   ...
   <td class="<? echo $estilo2 ?>"><a href="compra_grafico.php?unidad=<? echo $unidad; ?>&compraid=<? echo $ors['compra_id']; ?>&orden=<? echo $orden; ?>&anno=<? echo $anno; ?>" class="link"  ><? echo $ors['compra_nombre']; ?></a></td>
...
?>
 <tr>
   ...
   <td class="<? echo $estilo2 ?>"><a href="compra_grafico.php?unidad=<? echo $unidad; ?>&compraid=<? echo $compraid; ?>&orden=<? echo $orden; ?>&ocnumero=<? echo $ors['oc_numero']; ?>&ocetaid2=<? echo $ocetaid; ?>&anno=<? echo $anno; ?>" class="link"  ><? echo $ors['oc_nombre']; ?></a></td>
