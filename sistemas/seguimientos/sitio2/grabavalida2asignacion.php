...
//   echo $var1."----".$uno;
   ...
   if ($var1<>"" and $dos<>"") {
      $sql1="update dpp_etapas set eta_asignado='$dos', eta_destinatario2 = '', eta_rechaza_motivo4 = '' where eta_id=$var1 ";
       //echo $sql1;
      mysql_query($sql1);
   }
   ...
   if ($var1<>"" and $uno==3) {
   		...
   		//if ( ($nivelmio == 7 && $regionsession == 13) || ($nivelmio == 7 && $regionsession == 16)) {
...
echo "<script>location.href='valida2asignacion.php?llave=1';</script>";
