		...
		<div class="panel panel-signin">
			<div class="panel-body">
				<div class="logo text-center">
					<img src="images/logo.png" alt="SIGEJUN"  width="170">
				</div>
				<br />
				...
				<form id="frmLogin">
					<div class="input-group mb15">
						...
						<input type="text" name="usuario_rut" id="usuario_rut" class="form-control" placeholder="Username">
					</div><!-- input-group -->
					<div class="input-group mb15">
						<span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
						<input type="password" name="usuario_password" id="usuario_password" class="form-control" placeholder="Password">
					</div><!-- input-group -->
