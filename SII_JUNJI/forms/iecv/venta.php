<?php
extract($_POST);
require_once("includes/functions.iecvventa.php");
...
if(isset($cmd) && $cmd == "buscar")
{
    ...
    $dteCompras = getDTEVentas($periodo);
    $iecv = getIECVPeriodoVentas($periodo);
}
$totalIVA = 0;
$totalNETO = 0;
$totalEXENTO = 0;
...
<form class="form-horizontal" action="<?php echo $_SERVER["REQUEST_URI"] ?>" method="POST">
    <div class="panel panel-dark">
        <div class="panel-heading">
            ...
            <p>Información Electrónica de ventas</p>
        </div>
        <!-- CONTENIDO -->
...
<?php if ($cmd == "buscar"): ?>
    ...
    <input type="hidden" name="tipo_dcto" value="IECVVenta">
