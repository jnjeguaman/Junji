...
<script type="text/javascript">
	...
	{
		// if($.trim($("#sii_producto_qty_"+id).val()) == "")
		// {
		// 	$("#sii_producto_qty_"+id).val(0);
		// }
		$("#sii_producto_qty_"+id).val($.trim(parseInt($("#sii_producto_qty_"+id).val())));
		// console.log($("#sii_producto_qty_"+id).val());
	...
	{
		$("#sii_producto_costo_"+id).val($.trim(parseInt($("#sii_producto_costo_"+id).val())));
		var totalElementos = parseInt($("#totalElementos").val());
		var subtotal = 0;
	...
	{
		$("#sii_producto_desc_"+id).val($.trim(parseInt($("#sii_producto_desc_"+id).val())));
	...
	function reCalcular()
	{
		console.log($("#totalElementos").val());
